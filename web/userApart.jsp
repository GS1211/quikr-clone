...
<nav class="navbar navbar-inverse">
  <div class="container-fluid" >
    <div class="navbar-nav mr-auto">
      <a class="navbar-brand" href="loginpage.html">MyHOME</a>
    </div>
  </div>
</nav>
<div class="container">
    ...
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<center><form id="form" action="AppartmentMain" method="post" enctype="multipart/form-data">
			...
			<!--	<div class="form-group">
				...
				<div class="form-group">
                    <input type="text" name="bedroom" class="form-control input-lg" placeholder="No of seats" required>
				</div>
				<div class="form-group">
				...
				<div class="row">
					<div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <a href = "showData.jsp"><button type="button" class="btn btn-lg btn-success btn-block"> Show Data </button></a> 
					</div>
				</div>
			</fieldset>
		</form></center>
